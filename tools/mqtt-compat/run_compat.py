...
Opifex intentionally does not satisfy yet are NOT removed from the denominator —
...
EXPECTED_GAPS = {
    "v5": {
        ...
        "test_subscribe_identifiers":
            ...
            "Subscription Identifier ( [MQTT-3.3.4-4])",
    },
    "v3": {},
}
...
def render_markdown(reports):
    ...
    lines.append("<sub>⚠️ expected = a feature Opifex intentionally does not "
